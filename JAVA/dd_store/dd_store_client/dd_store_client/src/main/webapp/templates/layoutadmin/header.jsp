				...
				<div class="navbar-collapse collapse" id="navbarSupportedContent"
					...
					<ul class="navbar-nav ms-auto d-flex align-items-center">
						...
						<li><a class="profile-pic" href="#"> <img
								...
								class="text-white font-medium">Steave</span></a></li>
						<!-- ============================================================== -->
						<!-- User profile and search -->
						<!-- ============================================================== -->
					</ul>
					...
					<ul id="sidebarnav">
						...
						<li class="sidebar-item"><a
							...
							href="account" aria-expanded="false"> <i class="fa fa-table"
								aria-hidden="true"></i> <span class="hide-menu">Table Account</span>
						</a></li>
						...
						<li class="sidebar-item"><a
							...
							href="product" aria-expanded="false"> <i
								...
								class="hide-menu">Table Product</span>
						</a></li>
						
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
							href="brand" aria-expanded="false"> <i
								class="fa fa-table" aria-hidden="true"></i> <span
								class="hide-menu">Table Brand</span>
						</a></li>
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
							href="category" aria-expanded="false"> <i
								class="fa fa-table" aria-hidden="true"></i> <span
								class="hide-menu">Table Category</span>
						</a></li>
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
