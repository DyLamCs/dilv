					...
					<div class="card-body">
						...
						<form action="/student-manager/student/update" method="post">
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" id="age" name="age" value="${student.age }">
							</div>
							
							<div class="form-group">
								<label for="address">Address:</label> 
								<textarea style="height:100px" class="form-control" type="text" id="address" name="address" >${student.address }</textarea>
							</div>
